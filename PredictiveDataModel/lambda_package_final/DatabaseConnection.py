...
class DatabaseConnection:
    """Singleton database connection manager for Supabase PostgreSQL"""
    ...
    def _create_connection(self):
        """Create new Supabase database connection"""
        try:
            logger.info("Attempting to connect to Supabase database...")
            
            # Supabase connection parameters
            # You can use either direct connection or connection pooling
