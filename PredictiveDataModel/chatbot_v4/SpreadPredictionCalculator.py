...
class SpreadPredictionCalculator:
    ...
    def _calc_situational_ats(
        ...
        favored_data = [{'total_games': favored_result[0][0], 'ats_wins': favored_result[0][1]}] if favored_result else []
        ...
        # Convert to dict (pg8000 returns list of tuples)
        underdog_data = [{'total_games': underdog_result[0][0], 'ats_wins': underdog_result[0][1]}] if underdog_result else []
