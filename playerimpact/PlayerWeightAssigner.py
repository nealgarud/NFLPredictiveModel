...
class PlayerWeightAssigner:
    ...
    def __init__(self, madden_data=None):
        ...
        self.position_tier_weights = {
            ...
            'QB': {'elite': 0.900, 'good': 0.810, 'average': 0.720, 'below': 0.630},  # Default QB weight
            
            # Running Backs
            'RB1': {'elite': 0.475, 'good': 0.428, 'average': 0.380, 'below': 0.333},
            'RB2': {'elite': 0.175, 'good': 0.158, 'average': 0.140, 'below': 0.123},
            'RB': {'elite': 0.325, 'good': 0.293, 'average': 0.260, 'below': 0.228},  # Default RB weight
            ...
            'WR': {'elite': 0.300, 'good': 0.270, 'average': 0.240, 'below': 0.210},  # Default WR weight
            
            # Tight Ends
            'TE1': {'elite': 0.300, 'good': 0.270, 'average': 0.240, 'below': 0.210},
            'TE2': {'elite': 0.150, 'good': 0.135, 'average': 0.120, 'below': 0.105},
            'TE': {'elite': 0.225, 'good': 0.203, 'average': 0.180, 'below': 0.158},  # Default TE weight
            ...
            'T': {'elite': 0.338, 'good': 0.304, 'average': 0.270, 'below': 0.237},  # Default Tackle
            'G': {'elite': 0.150, 'good': 0.135, 'average': 0.120, 'below': 0.105},  # Default Guard
            'OL': {'elite': 0.250, 'good': 0.225, 'average': 0.200, 'below': 0.175},  # Generic OL
            
            # Edge Rushers
            'EDGE1': {'elite': 0.400, 'good': 0.360, 'average': 0.320, 'below': 0.280},
            'EDGE2': {'elite': 0.300, 'good': 0.270, 'average': 0.240, 'below': 0.210},
            'EDGE': {'elite': 0.350, 'good': 0.315, 'average': 0.280, 'below': 0.245},  # Default EDGE
            'DE': {'elite': 0.350, 'good': 0.315, 'average': 0.280, 'below': 0.245},  # Defensive End
            
            # Defensive Tackles
            'DT1': {'elite': 0.250, 'good': 0.225, 'average': 0.200, 'below': 0.175},
            'DT2': {'elite': 0.150, 'good': 0.135, 'average': 0.120, 'below': 0.105},
            'DT': {'elite': 0.200, 'good': 0.180, 'average': 0.160, 'below': 0.140},  # Default DT
